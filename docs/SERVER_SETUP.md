...
## Phone app (PWA) — shop Wi‑Fi or Tailscale

The shop server can serve a **lighter phone app** (orders, notes, messages, photos, time clock). No Apple fee. Employees Add to Home Screen from Safari.
